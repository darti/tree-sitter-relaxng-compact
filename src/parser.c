...
enum {
  ...
  aux_sym_string_content_repeat1 = 30,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [18] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_content, 1),
  [20] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [22] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_content_repeat1, 2),
  [24] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(6),
  [27] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_namespace, 4),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 2),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 3),
