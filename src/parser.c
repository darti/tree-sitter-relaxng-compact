...
enum {
  ...
  anon_sym_COLON = 32,
  anon_sym_COLON_STAR = 33,
  anon_sym_DASH = 34,
  anon_sym_datatypes = 35,
  ...
  sym_decl = 42,
  sym_namespace = 43,
  sym_default_namespace = 44,
  sym_pattern = 45,
  sym_grammar_content = 46,
  sym_start = 47,
  sym_define = 48,
  sym_assignMethod = 49,
  sym_literal = 50,
...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_COMMA] = "concat",
  [anon_sym_AMP] = "conjonction",
  [anon_sym_PIPE] = "|",
  [anon_sym_QMARK] = "\?",
  [anon_sym_STAR] = "*",
  [anon_sym_PLUS] = "+",
  ...
  [sym_start] = "start",
  [sym_define] = "define",
  [sym_assignMethod] = "assignMethod",
  [sym_literal] = "literal",
  [sym_string_content] = "string_content",
  [sym_name_class] = "name_class",
  [sym_except_name_class] = "nsname",
  [aux_sym_source_file_repeat1] = "source_file_repeat1",
  [aux_sym_source_file_repeat2] = "source_file_repeat2",
  [aux_sym_string_content_repeat1] = "string_content_repeat1",
  [alias_sym_anyname] = "anyname",
  [alias_sym_union] = "union",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_grammar_content] = sym_grammar_content,
  [sym_start] = sym_start,
  [sym_define] = sym_define,
  [sym_assignMethod] = sym_assignMethod,
  [sym_literal] = sym_literal,
  [sym_string_content] = sym_string_content,
  [sym_name_class] = sym_name_class,
  [sym_except_name_class] = anon_sym_COLON_STAR,
  [aux_sym_source_file_repeat1] = aux_sym_source_file_repeat1,
  [aux_sym_source_file_repeat2] = aux_sym_source_file_repeat2,
  [aux_sym_string_content_repeat1] = aux_sym_string_content_repeat1,
  [alias_sym_anyname] = alias_sym_anyname,
  [alias_sym_union] = alias_sym_union,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_default_namespace] = STATE(8),
    [sym_pattern] = STATE(63),
    [sym_grammar_content] = STATE(55),
    [sym_start] = STATE(78),
    [sym_define] = STATE(78),
    ...
    [anon_sym_notAllowed] = ACTIONS(19),
    [anon_sym_grammar] = ACTIONS(21),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(118),
  [38] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(115),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 2),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_literal, 2),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_namespace, 4),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_namespace, 4),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_default_namespace, 4),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_default_namespace, 4),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_default_namespace, 5),
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_default_namespace, 5),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl, 1),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_decl, 1),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal, 3),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_literal, 3),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 3, .production_id = 6),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 3, .production_id = 6),
  ...
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 5),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 5),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 1),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 1),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 3, .production_id = 5),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 3, .production_id = 5),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 4),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 4),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 3, .production_id = 4),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 3, .production_id = 4),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 2),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 2),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 3),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_pattern, 3),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignMethod, 1),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignMethod, 1),
  [115] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_start, 3),
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_start, 3),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [123] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [125] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_define, 3),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_define, 3),
  ...
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat2, 2),
  [151] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(73),
  [154] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(117),
  [157] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(85),
  [160] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(89),
  [163] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(113),
  [166] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(83),
  ...
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_class, 2, .production_id = 3),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_class, 1, .production_id = 1),
  ...
  [207] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_content, 4),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_content, 4),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_content, 1),
  [213] = {.entry = {.count = 1, .reusable = true}}, SHIFT(80),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_content, 3),
  [217] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_content, 3),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_content, 1),
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grammar_content, 1),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_content_repeat1, 2),
  [225] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_content_repeat1, 2), SHIFT_REPEAT(80),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_class, 3, .production_id = 7),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_class, 3),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_except_name_class, 2),
  [234] = {.entry = {.count = 1, .reusable = true}}, SHIFT(87),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_class, 2, .production_id = 2),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_class, 3, .production_id = 8),
...
extern const TSLanguage *tree_sitter_relaxng_compact(void) {
